...
- SEC/FINTRX (AG Dillon Asset Management LP, registered May 7, 2026): $262M AUM, 28 accounts, ~$9.4M avg. account — may reflect a restructured entity, not directly comparable to the site figure.

## Terms
- $2,500 minimum, accredited investors only, financial-advisors-only distribution.
- Custody: Schwab; Fidelity "under review" for newer funds.

## Sources
- [AG Dillon Funds page](https://agdillon.com/funds/)
- [AG Dillon Products page](https://agdillon.com/products/)
- [AG Dillon About / Aaron Dillon bio](https://agdillon.com/about/)
- [FINTRX — AG Dillon Asset Management LP](https://www.fintrx.com/firms/firm/ag-dillon-asset-management-lp-328384)
- [SEC IAPD — AG Dillon Asset Management LP](https://adviserinfo.sec.gov/firm/summary/328384)
- [Private Equity International — AG Dillon institution profile](https://www.privateequityinternational.com/institution-profiles/ag-dillon-co.html)
...
## Update — 2026-09-07 (new fund filings, fund count, AUM corroboration)

**Two new funds confirmed via primary EDGAR Form D filings — genuinely new deal flow beyond the AGDF26 ceiling this file previously tracked:**

- **AGDF29 LP** (CIK 0002151475) and **AGDF30 LP** (CIK 0002151476) — both filed Form D on **2026-08-28**. Both list **AG Dillon LLC** as General Partner/Promoter and **Aaron Dillon** as founder/Managing Director of the GP's managing member, signed by **Christopher Plummer, CCO** — independently confirmed as genuine AG Dillon entities directly from each fund's `primary_doc.xml` on EDGAR, not just an aggregator's grouping. 🟢 primary source (SEC EDGAR Form D).
  - AGDF29 LP: $2,072,460 sold, 91 investors (per Radient Analytics' fund-raising table; investor count not independently re-verified from the primary doc, which does not itemize it in the excerpt pulled).
  - AGDF30 LP: $1,874,580 sold, 91 investors (same sourcing note).
  - $2,500 minimum capital commitment confirmed on AGDF29's primary doc, consistent with the terms already on file.
- **AGDF19 LP** (previously listed above only as "theme not disclosed, open") — Form D filed 2026-04-21 shows $3,670,000 sold, 46 investors. Fills in a detail gap; theme still not disclosed.
- **Fund count / gross asset value:** Radient Analytics (a Form ADV/Form D aggregator, not a primary source) shows AG Dillon Asset Management LP with **27 private funds, $252.5M total gross asset value**, as of its most recent scrape — up from the firm's own stale "25 funds" (Sep 2025) marketing figure. 🟡 aggregator-sourced; fund count trend direction (up) is corroborated by the two new AGDF29/30 filings above, but the precise 27-fund/$252.5M figures were not independently re-tallied from EDGAR this run.
- **AUM $262M reconfirmed independently:** RIA Intel (data as of May 1, 2026 Form ADV, filed May 31, 2026) shows the same $262M total AUM / 28 accounts / $9M avg. account already sourced from FINTRX in the "Firm scale" section above — now corroborated by a second independent aggregator citing the same underlying SEC Form ADV filing, not merely repeating FINTRX's number. Still flagged as a separately registered entity (AG Dillon Asset Management LP, CRD 328384) that may not be directly comparable to the firm's own $140M site figure.
...
## Update — 2026-09-14 (2): Positron identity resolved (high confidence); AGDF31 gap corroborated via a fifth method; no new Form D

Following up directly on the gap Kelly's advisor-portal table opened above (the "Positron Fund" name, unattested anywhere else in this file):

**Positron identity — 🟢 high confidence: Positron AI (positron.ai), the Reno, NV AI-inference-chip startup, not the aerospace/space-reentry-vehicle company also named "Positron."** Reasoning:
- Kelly's table lists Positron Fund's asset class as **"AI Infrastructure (Semiconductors)"** — an exact match to Positron AI's business (a fabless semiconductor company building Nvidia-competitor inference chips: Atlas, shipping now; Asimov, next-gen). No aerospace/reentry-vehicle "Positron" has any comparable funding profile or public presence found this run — that company (if it exists as a going concern) generated zero search results in this pass, while Positron AI generated extensive, dated, primary-source coverage.
- **Timing is the strongest corroborating signal**: Positron AI closed an **$875M Series C (Series C + C-1) on 2026-09-10** — four days before this check — at a **$5B valuation**, more than 4x its $1.06B Series B valuation from February 2026 (round co-led by NEA, Atreides Management, Valor Equity Partners, Andra Capital, SemiAnalysis Capital, and Jim Clark). 🟢 primary/near-primary: [Reuters via Investing.com, 2026-09-10](https://www.investing.com/news/stock-market-news/ai-chip-startup-positrons-valuation-skyrockets-in-latest-funding-round-4896462); corroborated by [U.S. News/Reuters](https://money.usnews.com/investing/news/articles/2026-09-10/ai-chip-startup-positrons-valuation-skyrockets-in-latest-funding-round) and [TechBuzz](https://www.techbuzz.ai/articles/positron-lands-230m-to-challenge-nvidia-s-ai-chip-dominance). A company this newly hot (4x markup in 7 months, oversubscribed enough to add a C-1 tranche) is exactly the profile of name AG Dillon has historically targeted (Anduril, xAI, Groq — high-profile, recently-repriced AI/infrastructure names), and explains why a dedicated AGD single-stock fund would exist for it right now.
- Not independently confirmed: no AG Dillon-side document (fact sheet, Form D, podcast mention) naming Positron AI specifically was located — this is an inference from theme-match + timing, not a direct AG Dillon citation. Treat as high-confidence identification, not a confirmed fact, pending a primary AG Dillon source using the company's full name.

**AGDF31/AGDF33+ gap — further corroborated, still unresolved.** Ran a fifth, methodologically distinct check: an EDGAR company-name browse (`browse-edgar?action=getcompany&company=AGDF31&type=D`) rather than the full-text search used in the four prior checks (09-08, 09-09, 09-11, 09-12) — this queries the registrant-name index directly rather than filed-document text. **Zero results for "AGDF31" and zero for "AGDF33."** A full company-name browse for `company=AGDF` confirms the complete registered set stops at **AGDF32 LP** (CIK 2151478, filed 2026-09-04) with no higher-numbered entity registered under that naming convention as of this check. This doesn't newly resolve the gap (still no explanation for why 31 was skipped) but rules out "search-tool coverage miss" as the explanation across a fifth independent method — strengthens the case that AGDF31 was either deliberately skipped/reserved or filed under a different legal name entirely (plausibly consistent with "Positron Fund" / "Harvey Fund 2" being registered, if at all, under their plain-English names rather than the AGDF-numeric convention — see below).
- Also ran EDGAR full-text search for `"Positron Fund"` and for `"Harvey Fund" "AG Dillon"` — **zero hits on both**, and zero hits for "AGDF31" across all form types. This is consistent with (not contradictory to) the file's standing hypothesis that these newer, advisor-portal-only single-stock SPVs may rely on the Section 4(a)(2) exemption and file no Form D at all, or may be too new/not yet indexed. No Form D found under either plain-English name.
- No new AGDF Form D filings beyond AGDF32 (still filed 2026-09-04) as of this 2026-09-14 check — the pace-of-roughly-one-new-fund-per-week pattern documented through early September appears to have paused for at least 10 days, or new funds in this window are being filed under non-AGDF-numeric names not yet identified.

**AUM discrepancy — unchanged, no new data point.** Re-checked agdillon.com/funds directly: still shows the stale "25 venture capital funds with $140 million AUM across 45 RIA/IBD partners (as of Sep 2025)" marketing line, unchanged from every prior check since 2026-08-22. No new SEC Form ADV filing found (still May 2026 filing, $262M). The three-way discrepancy ($140M site / $221M LinkedIn / $262M Form ADV) stands with no new information either way.
